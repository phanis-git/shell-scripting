...
curl -L -o /tmp/cart.zip https://roboshop-artifacts.s3.amazonaws.com/cart-v3.zip  &>>$logFileName
...
# Creating service file for running cart.service
cp $SCRIPT_DIRECTORY/cart.service /etc/systemd/system/cart.service
VALIDATE $? "Created service file for cart to run systemctl commands"

# Loading the service
systemctl daemon-reload
VALIDATE $? "daemon-reload"

# Enable cart service or cart
systemctl enable cart 
VALIDATE $? "enable cart"

# Start cart service or cart
